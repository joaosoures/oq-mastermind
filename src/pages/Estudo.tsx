                      ...
                      <div key="confirm" className="flex-1 flex items-center justify-end">
                        <div className="w-full max-w-[160px]">
                          {modoState.finalized ? (
                            ...
                            <TactileButton variant="accent" disabled={!modoState.canConfirm} className="w-full h-14 text-lg font-black tracking-widest uppercase shadow-[0_0_20px_hsl(var(--accent)/0.3)]" onClick={() => modoRef.current?.confirm()}>Confirmar</TactileButton>
                          )}
                        </div>
                      </div>
                    );
